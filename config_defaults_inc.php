...
$config_file = empty( $_SERVER['CONFIG_INC'] ) ? BIT_ROOT_PATH.'config/config_inc.php' : $_SERVER['CONFIG_INC'];
if( file_exists( $config_file ) ) {
	include_once( $config_file );
}

// =================== Essential Defines ===================
// These defines can be set in config/config_inc.php. If they haven't been set, we set default values here
// database settings
...
global $gPreScan;
if( empty( $gPreScan ) ) {
	$gPreScan = array( 'kernel', 'config', 'storage', 'liberty', 'lcconfig', 'themes', 'users', 'switchboard' );
}

// here we set the default thumbsizes we use in bitweaver.
// you can override these by populating this hash in your config/config_inc.php
global $gThumbSizes;
